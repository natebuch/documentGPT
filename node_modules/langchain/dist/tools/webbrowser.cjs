...
class WebBrowser extends base_js_2.Tool {
    constructor({ model, headers, embeddings, verbose, callbackManager, axiosConfig, }) {
        ...
        Object.defineProperty(this, "description", {
            ...
            configurable: true,
            writable: true,
            value: `useful for when you need to find something on or summarize a webpage. input should be a comma seperated list of "valid URL including protocol","what you want to find on the page or empty string for a summary".`
        });
        this.model = model;
    ...
    async _call(inputs) {
        ...
        const input = `${context}\n\nI need ${doSummary ? "a summary" : task} from the previous text, also provide up to 5 markdown links from within that would be of interest (always including URL and text). Links should be provided, if present, in markdown syntax as a list under the heading "Relevant Links:".`;
