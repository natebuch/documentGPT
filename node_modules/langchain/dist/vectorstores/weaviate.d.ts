...
export declare class WeaviateStore extends VectorStore {
    ...
    similaritySearch(query: string, k: number, filter?: WeaviateFilter): Promise<Document[]>;
    similaritySearchWithScore(query: string, k: number, filter?: WeaviateFilter): Promise<[Document, number][]>;
